...
class TestBatchExecutionDetailModel:
    ...
    def test_batch_execution_detail_creation(self, sample_batch_execution_detail):
    ...
    def test_batch_execution_detail_to_dict(self, sample_batch_execution_detail):
...
class TestBatchExecutionModelIntegration:
    ...
    def test_batch_execution_crud_operations(self, db_session):
        ...
        # Read
        retrieved_batch = db_session.query(BatchExecution).filter_by(id=batch.id).first()
        ...
        updated_batch = db_session.query(BatchExecution).filter_by(id=batch.id).first()
        ...
        deleted_batch = db_session.query(BatchExecution).filter_by(id=batch.id).first()
    ...
    def test_batch_execution_detail_crud_operations(self, db_session):
        ...
        # Read
        retrieved_detail = db_session.query(BatchExecutionDetail).filter_by(id=detail.id).first()
        ...
        updated_detail = db_session.query(BatchExecutionDetail).filter_by(id=detail.id).first()
        ...
        deleted_detail = db_session.query(BatchExecutionDetail).filter_by(id=detail.id).first()
    ...
    def test_foreign_key_relationship(self, db_session):
        ...
        # 関連レコードの確認
        details = db_session.query(BatchExecutionDetail).filter_by(batch_execution_id=batch.id).all()
