...
class TestDatabaseFixtures:
    ...
    def test_test_db_session_context(self, test_db_session):
        ...
        assert hasattr(result_session, "commit")
        assert hasattr(result_session, "rollback")
        assert hasattr(result_session, "close")
...
class TestDataFixtures:
    ...
    def test_sample_stock_data_structure(self, sample_stock_data):
        ...
        for key in required_keys:
            assert key in sample_stock_data
    ...
    def test_sample_stock_list_structure(self, sample_stock_list):
        ...
        # Arrange (準備)
        required_keys = ["symbol", "name", "close"]
    ...
    def test_sample_stock_list_values(self, sample_stock_list):
        ...
        # Arrange (準備)
        expected_symbols = ["7203.T", "6758.T", "9984.T"]
